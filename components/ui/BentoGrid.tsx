...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('amomensah300@gmail.com');
    setCopied(true);
  };
  return (
    <div
    ...
    >
      ...
      <div className={cn(titleClassName, 'group-hover/bento:translate-x-2 transition relative duration-200 md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10')}>
      ...
      {id === 3 && (
        ...
        absolute -right-3 lg:-right-2">
          ...
          <div className="flex flex-col gap-3 lg:gap-8">
          <span className="lg:py-4 lg:px-3 py-4 px-3 rounded-lg text-center bg-[#10132E]" />
            {['TailwindCSS', 'MongoDB', 'GraphQL'].map((item) => (
